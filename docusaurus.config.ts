...
const config: Config = {
    ...
    title: 'Life Style Brand VMD',
    tagline: 'Han Seung ju',
    ...
    organizationName: 'rilian96', // TODO( github username e.g. seonWKim )
    projectName: 'Gloria', // TODO( github repository name e.g. simple-web-programming )
